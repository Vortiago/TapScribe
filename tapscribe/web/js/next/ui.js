...
/**
 * Copy `text` via the async Clipboard API when it's usable, else run the
 * caller's fallback UX. `onOk` fires only on a successful clipboard write;
 ...
 * (a prompt vs a populated new tab).
 * @param {string} text
