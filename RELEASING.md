...
Release notes are drafted from PR labels by release-drafter. The Windows
artifacts are unsigned (SmartScreen may warn). The bridge zip and Bundle
**filenames are stable and unversioned** so
