...
_GOLDEN = frozenset(
    {
        ...
        ("POST", "/api/sessions/{session}/diarize", "api_session_diarize"),
        ("GET", "/api/sessions/{session}/voices", "api_session_voices"),
        ("PUT", "/api/sessions/{session}/voices", "api_session_voice_mapping"),
